...
1. Character: Represents text strings, symbols, or words. Must always be enclosed in quotes.
2. Numeric: Represents real numbers.
3. Logical: Represents Boolean values for binary conditions.
