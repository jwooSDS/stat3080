...
- `message = FALSE`: which hides messages that R produces from your document.
- `warning = FALSE`: which hides warnings that R produces from your document.
...
## Cross-Referencing with R Markdown

**Cross-referencing** is done in a document to help connect related information to readers. You will often that you will want to connect a narrative with a graphical output, information presented in a table, a math equation, or a citation. 
...
```{r plot-pressure, fig.cap="Vapor Pressure of Mercury in mm Hg Against Temp in Celcius", echo=FALSE}
plot(pressure)  # a scatterplot
```
...
This is just a simple example. Referencing tables and equations are similar. Details can be found in @xie2020 Chapter 4.7.
...
- [Cross-Referencing Figures, Equations, and Tables Within Documents](https://pkg.yihui.org/rmarkdown-cookbook/cross-ref). 
