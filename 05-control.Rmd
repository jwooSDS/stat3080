...
However, in control flows, we want logical expressions to return an output of length 1 (a scalar), so you should use `&&` for and and `||` for or. 
...
## we have fill the vector with something at the start
