...
We often want to apply the same function separately to each element of a vector. R has the `apply` family of functions that implement loops in specialized use cases. This family of functions is useful since it:
...
We often compute sums or means of columns or rows that there functions that produce the same output as equivalent `apply()` versions:
