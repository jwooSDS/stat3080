...
```{r ch8scatter_plain, fig.cap="Basic Scatterplot using ggplot"}
...
From the scatterplot in Figure \@ref(ch8scatter_plain), it looks like flipper length and body mass have a fairly strong positive linear relationship. As flipper length increases, body mass generally increases. If we were to draw an imaginary line through the plots, the plots fall fairly close to the line.
