...
**Thought question:** How would you use this simulation to estimate the probability $P(\bar{X} > 0.5)$ when $n=10$ and the data $X_1, \cdots, X_n$ are i.i.d. standard normal? 
...
**Thought question:** How would you use this simulation to estimate the probability $P(\bar{X} > 0.3)$ when $n=25$ and the data $X_1, \cdots, X_n$ are i.i.d. exponential with rate parameter 1? 
